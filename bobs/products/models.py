...
class Product(models.Model):
    ...
    sku = models.CharField(max_length=200, default=uuid.uuid4, unique=True,
                           editable=False)
    ...
    contains_allergin = models.ManyToManyField("Allergin", blank=True,
                                               related_name="contains")
    may_contain_allergin = models.ManyToManyField("Allergin", blank=True,
                                                  related_name="may_contain")
